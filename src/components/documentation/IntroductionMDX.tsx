  ...
  return (
    <div className="space-y-4 sm:space-y-6 text-white">
      <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
        <Globe className="h-5 w-5 sm:h-6 sm:w-6 text-blue-400 flex-shrink-0" />
        <h3 className="text-lg sm:text-xl font-semibold">Pengenalan Web3 dan Blockchain</h3>
      </div>
      
      <div className="grid gap-3 sm:gap-4 md:gap-6">
        <div className="bg-gray-800/50 p-3 sm:p-4 md:p-6 rounded-lg border border-gray-700/50 hover:border-blue-500/30 transition-all duration-300">
          <div className="flex items-start space-x-2 sm:space-x-3 mb-2 sm:mb-3">
            <Globe className="h-4 w-4 sm:h-5 sm:w-5 text-blue-400 mt-1 flex-shrink-0" />
            <h4 className="font-semibold text-blue-400 text-sm sm:text-base">Web3 (Web 3.0)</h4>
          </div>
        ...
        <div className="bg-gray-800/50 p-3 sm:p-4 md:p-6 rounded-lg border border-gray-700/50 hover:border-blue-500/30 transition-all duration-300">
          <div className="flex items-start space-x-2 sm:space-x-3 mb-2 sm:mb-3">
            ...
            <h4 className="font-semibold text-green-400 text-sm sm:text-base">Blockchain</h4>
          </div>
          <p className="text-gray-300 leading-relaxed text-xs sm:text-sm md:text-base">
        ...
        <div className="bg-gray-800/50 p-3 sm:p-4 md:p-6 rounded-lg border border-gray-700/50 hover:border-blue-500/30 transition-all duration-300">
          <div className="flex items-start space-x-2 sm:space-x-3 mb-2 sm:mb-3">
            <Code className="h-4 w-4 sm:h-5 sm:w-5 text-purple-400 mt-1 flex-shrink-0" />
            <h4 className="font-semibold text-purple-400 text-sm sm:text-base">Smart Contract</h4>
          </div>
          <p className="text-gray-300 leading-relaxed text-xs sm:text-sm md:text-base">
        ...
        <div className="bg-gray-800/50 p-3 sm:p-4 md:p-6 rounded-lg border border-gray-700/50 hover:border-blue-500/30 transition-all duration-300">
          <div className="flex items-start space-x-2 sm:space-x-3 mb-2 sm:mb-3">
            <DollarSign className="h-4 w-4 sm:h-5 sm:w-5 text-yellow-400 mt-1 flex-shrink-0" />
            <h4 className="font-semibold text-yellow-400 text-sm sm:text-base">DeFi (Decentralized Finance)</h4>
          </div>
          <p className="text-gray-300 leading-relaxed text-xs sm:text-sm md:text-base">
