...
const Dashboard = () => {
  ...
  const setupRealtimeSubscriptions = () => {
    ...
    // Enhanced audit history subscription with AI status updates
        ...
        (payload) => {
          ...
          if (payload.eventType === 'INSERT') {
            ...
            toast({
              ...
              description: `Smart contract "${newAudit.contract_name}" analyzed with score ${newAudit.audit_score}`,
              duration: 5000,
            });
    ...
    // Enhanced watchlist subscription with risk analysis updates
    const watchlistChannel = supabase
      ...
      .on(
        ...
        (payload) => {
          console.log('Real-time watchlist update:', payload);
          ...
          if (payload.eventType === 'INSERT') {
            ...
            // Show notification for risk level updates
  ...
  const addToWatchlist = async () => {
    ...
    try {
      ...
      // Show immediate feedback while AI analyzes
      toast({
  ...
  const removeFromWatchlist = async (id: string) => {
    try {
      ...
      toast({
        title: "✅ Removed",
        description: "Address removed from monitoring",
      });
    } catch (error) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center">
        <div className="text-center space-y-4 animate-fade-in">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-400">Initializing AI-powered security analysis...</p>
          </div>
        </div>
      </div>
    );
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-3xl lg:text-4xl font-bold text-white mb-1">
                    SafeChain AI Dashboard
                  </h1>
                  <p className="text-gray-400 text-sm lg:text-base">
                    Real-time AI Security Analysis • Live Monitoring • Instant Alerts
                  </p>
                </div>
              </div>
            </div>
                      ...
                      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                        <div>
                          <CardTitle className="text-white text-xl flex items-center gap-2">
                            ...
                            AI Audit History (Real-time)
                          </CardTitle>
                          <CardDescription className="text-gray-400 mt-1">
                            Live updates from AI security analysis
                          </CardDescription>
                        </div>
                      ...
                      {filteredAudits.length > 0 ? (
                          ...
                          <Table>
                            <TableHeader>
                              <TableRow className="border-gray-700 hover:bg-gray-800/20">
                                ...
                                <TableHead className="text-gray-300 font-medium">AI Score</TableHead>
                        ...
                        <div className="text-center py-12 animate-fade-in">
                          ...
                          <p className="text-gray-400 text-lg font-medium">
                            {searchTerm || filterStatus !== 'all' ? 'No results found' : 'No AI audits yet'}
                          </p>
                          <p className="text-gray-500 text-sm mt-2">
                            {searchTerm || filterStatus !== 'all' ? 'Try different search terms' : 'Start by auditing smart contracts with AI'}
                          </p>
                        </div>
                      )}
                    </CardContent>
                  ...
                  <Card className="bg-gray-800/40 backdrop-blur-sm border-gray-700/50">
                    <CardHeader>
                      <CardTitle className="text-white text-xl flex items-center gap-2">
                        ...
                        AI Wallet Monitor (Live)
                      </CardTitle>
                      <CardDescription className="text-gray-400">
                        Real-time AI risk analysis and monitoring
                      </CardDescription>
                    </CardHeader>
                      ...
                      <div className="space-y-3 max-h-96 overflow-y-auto custom-scrollbar">
                        {filteredWatchlist.length > 0 ? (
                                  ...
                                  {item.risk_level === 'Analyzing...' && (
                                    <>
                                      ...
                                      <div className="flex items-center gap-1">
                                        ...
                                        <span className="text-blue-400 text-xs">AI analyzing...</span>
                                      </div>
                                    </>
                                  )}
                                </div>
                          ...
                          <div className="text-center py-12 animate-fade-in">
                            ...
                            <p className="text-gray-500 text-sm mt-2">
                              {searchTerm ? 'Try different keywords' : 'Add wallet addresses for AI risk monitoring'}
                            </p>
                          </div>
                        )}
                      </div>
